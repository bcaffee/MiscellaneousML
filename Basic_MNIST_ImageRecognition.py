...
class ConvNet:
    ...
    def __init__(self, image_height, image_width, channels, num_classes):
        ...
        conv_layer_1 = tf.compat.v1.layers.conv2d(self.input_layer, filters=32, kernel_size=[5, 5], padding="same",
        ...
        pooling_layer_1 = tf.compat.v1.layers.max_pooling2d(conv_layer_1, pool_size=[2, 2], strides=2)
        print(pooling_layer_1.shape)

        conv_layer_2 = tf.compat.v1.layers.conv2d(pooling_layer_1, filters=64, kernel_size=[5, 5], padding="same",
                                                  activation=tf.nn.relu)
        print(conv_layer_2.shape)

        pooling_layer_2 = tf.compat.v1.layers.max_pooling2d(conv_layer_2, pool_size=[2, 2], strides=2)
        ...
        self.train_operation = optimizer.minimize(loss=self.loss, global_step=tf.compat.v1.train.get_global_step())
...
with tf.compat.v1.Session() as sess:
    checkpoint = tf.compat.v1.train.get_checkpoint_state(path)
    saver.restore(sess, checkpoint.model_checkpoint_path)
